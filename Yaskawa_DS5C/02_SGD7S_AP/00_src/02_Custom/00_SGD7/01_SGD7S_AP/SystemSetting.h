...
#define	CSW_NETIF_TYPE		NETIF_ANLGPLS_TYPE
...
#define SVFSEL_VIRSIF_USE	(1)			/* 1: パネル使用 0: 未使用			*/
#define SVFSEL_PANELOP_USE	(1)			/* 1: パネル使用 0: 未使用			*/
...
/*		AD制御実行選択													 */
/*---------------------------------------------------------------------------*/
#define		SVFSEL_ADC_USE 			(0)				/* 1: ADC?? 0: 枹??		<S09F>	*/
/*--------------------------------------------------------------------------*/
/*		オプションカード対応定義											*/
/*--------------------------------------------------------------------------*/
...
#define	SVFSEL_ONLY_OH_ADC_USE 		(0)		/* 1: ADC使用 0: 未使用			*/
/*	デシメーションフィルタ	<S202>											*/
...
/*		AD制御実行選択													 */
/*---------------------------------------------------------------------------*/
#define		SVFSEL_ADC_USE 			(1)				/* 1: ADC?? 0: 枹??		 */
/*--------------------------------------------------------------------------*/
/*		オプションカード対応定義											*/
/*--------------------------------------------------------------------------*/
/* CSW_OPT_CARD_OPTION_SUPPORT ０ｘ＊＊＊＊									*/
...
/*		ScanN周期														 							*/
/*--------------------------------------------------------------------------------------------------*/
//#define KPI_SNCYCLENS			( 250000 )						/* 暫定: ScanN Cycle[ns] 			*/
#define KPI_SNCYCLENS			( KPI_SBCYCLE_BASE_NS )			/* 暫定: ScanN Cycle[ns] 			*/
#define KPI_SNCYCLEUS			( KPI_SNCYCLENS/1000 )			/* 暫定: ScanN Cycle[us] 			*/
#define KPI_SCANN_MS( ms )		( (ms*1000)/KPI_SNCYCLEUS )		/* 暫定: ScanN Cycle Count per 1ms	*/
...
//#define CFG_POSERR_DELAY		KPI_MBCYCLENS	/* TODO:見直し!!! 位置偏差モニタ用補正時間[ns] */
...
/*---------------------------------------------------------------------------*/
#define SERVO_ID			0x070		/* サーボ機種ID : SFD7S_AP = 0x0070 */
/* <S173> Start */
/* 入力/出力信号 有効/無効情報見直しの為、コメントアウト */
#if 0
...
/* 入力/出力信号 有効/無効情報見直し */
#define INPUT_SIGNAL_INFO	0x000000ff	/* 入力信号 有効/無効情報 */
										/* SI0～SI6,SI7(SEN信号):有効 */
										/* SI8～SI31:無効 */
#define OUTPUT_SIGNAL_INFO	0x0000007f	/* 出力信号 有効/無効情報 */
										/* ALM,SO1～SO6:有効 */
										/* SO7～SO31:無効 */
/* <S173> End */
/* <S056>	End */

#define ALM_WARNING_AUTO_CLEAR	TRUE	/* <S184> ワーニング自動クリア選択 */
...
/*																									*/
/****************************************************************************************************/
//#define		SVFSEL_PANELOP	(0)						/* パネル無										*/
//#define		CCSW_PANELID	PANELID_NONE			/* パネル無										*/
/*--------------------------------------------------------------------------------------------------*/
/*		パネルボタンスイッチ読込みマクロ															*/
/*--------------------------------------------------------------------------------------------------*/
#define	KPX_READ_PNLBTN( x )		{ ;}
/*--------------------------------------------------------------------------------------------------*/
/*		局アドレスロータリSW読込みマクロ															*/
/*--------------------------------------------------------------------------------------------------*/
#define	KPX_READ_PNLRTSW( x )		{ ;}
/*--------------------------------------------------------------------------------------------------*/
/*		通信設定ディップSW読込みマクロ																*/
/*--------------------------------------------------------------------------------------------------*/
#define	KPX_READ_PNLDPSW( x )		{ ;}
/*--------------------------------------------------------------------------------------------------*/

/****************************************************************************************************/
/*																									*/
/*		Servo Function Using Definition 															*/
/*																									*/
/****************************************************************************************************/
#include "SVFSEL.cfg"
