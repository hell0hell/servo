...
#define	CSW_NETIF_TYPE		NETIF_CM_TYPE
...
/*		寿命予測使用・不使用設定											*/
/*--------------------------------------------------------------------------*/
#define CSW_SVCF_LIFEPRED_USE 		FALSE									/* <S154> */
/*--------------------------------------------------------------------------*/
/*		消費電力モニタ使用・不使用設定										*/
/*--------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
#define SERVO_ID			0x073	/* サーボ機種ID : SFD7S_CM = 0x0073 */
...
/*---------------------------------------------------------------------------*/
#define		SVFSEL_ATGAINCHANGE_USE	(0)				/* 1: 自動ゲイン切替使用 0: 未使用				*/
/***************************************** end of file **********************************************/
