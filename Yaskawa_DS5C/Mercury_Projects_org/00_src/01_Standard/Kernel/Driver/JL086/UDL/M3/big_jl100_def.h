/****************************************************************************/
/*                                                                          */
/*        BIG_JL100_DEF.H : Common header of JL-100 access driver           */
/*                                                                          */
/****************************************************************************/
/*                                                                          */
/*       Defines:                                                           */
...
/***********************************************************************/
/*   Endian type difinition (Big endian ?)                             */
/***********************************************************************/
#ifdef __BIG_ENDIAN__
#define		BIG_ENDIAN
#define 	BIGENDIAN_16BIT		/* P1014 */
#endif
...
#define JL100_CID_LO_ADR		0x0000
#define JL100_CID_HI_ADR		0x100A
#define JL100_ARCV_TOUT_TIME	0xFFFF
/* JL102A,JL103A */
#define JL102_CID				0x0000102A
#define JL102_CID_LO_ADR		0x0000
#define JL102_CID_HI_ADR		0x102A
...
#if CSW_BOARD_TYPE == SGD7S_TYPE /* <S0A2S0A2> */
...
/***********************************************************************/
/*    Communication Parameter(Big endian)                              */
/***********************************************************************/
typedef union _JL100_COM_PAR {
	struct{
		volatile USHORT ma_msk0;			/* Receive address filter setting for ma0*/
		volatile USHORT ma0;				/* My Address */
		volatile USHORT ma_msk1;			/* Receive address filter setting for ma1 */
		volatile USHORT ma1;				/* Multicast Address */
		volatile USHORT ma_max;			/* Max Number of Slave */
		volatile USHORT srch_time;		/* Serch time for detecting slave */
		volatile USHORT t_unit;			/* Global Time Unit */
		volatile USHORT t_mcyc;			/* Tmcyc */
		volatile USHORT max_rtry;		/* Number of Max Retry */
		volatile USHORT prot_sel;		/* Protcol Select */
		volatile USHORT c1msg_sz;		/* C1 Message size */
		volatile USHORT msg_ptr;			/* C1 Message buffer area top address */
		volatile USHORT pkt_sz;			/* Sending size of one message frame */
		volatile USHORT c2msg_sz;		/* C2 Message size */
		volatile USHORT c2_dly;			/* C2 Master Send Start Time */
		volatile USHORT wdt;				/* Watch Dog Setting */
		volatile USHORT iomap_ptr;		/* IOMAP buffer area top address  */
		volatile USHORT dly_cnt;			/* Number of Transmition delay time measure */
		volatile USHORT max_frm;			/* Max Data size of PHY transfer */
		volatile USHORT ifgset;			/* Frame gap setting */
		volatile USHORT reserve2;		/*  */
		volatile USHORT reserve1;		/*  */
		volatile USHORT reserve4;		/*  */
		volatile USHORT reserve3;		/*  */
		volatile USHORT dummy;			/*  */
		volatile USHORT async_req_rtry;	/* Async start request retry count */
	} str;
...
/***********************************************************************/
/*    IOMAP Struct(Big endian)                                         */
/***********************************************************************/
typedef union _JL100_IO_MAP {
	struct{
		volatile USHORT t_rsp;			/* Response monitering time */
		volatile USHORT axis_adr;		/* My axis address */
		volatile USHORT rd_len;			/* Response data length */
		volatile USHORT cd_len;			/* Command data length */
		volatile USHORT tr_dly;			/* Transmission delay time */
		volatile USHORT sts_num;			/* Status number */
		volatile USHORT dummy2;			/* dummy */
		volatile USHORT dummy1;			/* dummy */
	} str;
	unsigned long ulong_ptr;
} JL100_IO_MAP;
...
typedef struct _JL100_IO_MAP_DWORD {
	volatile ULONG dword1;			/* Lo:axis_adr, Hi:t_rsp  */
	volatile ULONG dword2;			/* Lo:cd_len,   Hi:rd_len */
	volatile ULONG dword3;			/* Lo:sts_num,  Hi:tr_dly */
	volatile ULONG dword4;			/* Lo:dummy1,   Hi:dummy2 */
} JL100_IO_MAP_DWORD;
...
typedef struct _JL100_USER_IOMAP {
	volatile ULONG  t_rsp;			/* Response monitering time */
	volatile USHORT axis_adr;		/* My axis address */
	volatile USHORT cd_len;			/* Command data length */
	volatile USHORT rd_len;			/* Response data length */
	volatile USHORT cmdbuff_offset;	/* Command buffer offset */
	volatile USHORT rspbuff_offset;	/* Response buffer offset */
	volatile USHORT dummy;			/* dummy */
} JL100_USER_IOMAP;
...
typedef struct _JL100_USER_PAR {
	volatile ULONG  mod;				/* MOD register */
	volatile USHORT ma0;				/* My Address */
	volatile USHORT ma_max;			/* Max Number of Slaves */
	volatile ULONG  t_mcyc;			/* Tmcyc */
	volatile ULONG  intoffset;		/* Interrupt delay offset time */
	volatile ULONG  c2_dly;			/* C2 Master Send Start Time */
	volatile USHORT prot_sel;		/* Protocol Select */
	volatile USHORT max_rtry;		/* Max Number of Retry */
	volatile USHORT pkt_sz;			/* Sending Data size of One Message Frame */
	volatile USHORT wdt;				/* Watch Dog Setting */
	volatile USHORT dly_cnt;			/* Number of Transmition delay time measure */
	volatile USHORT reserve1;		/* Reserve */
} JL100_USER_PAR;
...
typedef union _JL100_REG_PAR {
	struct{
		volatile ULONG mod;				/* MOD register  */
		volatile ULONG imk;				/* IMK register  */
		volatile ULONG pars;				/* PARS register */
		volatile ULONG idly;				/* IDLY register */
	} str;
	unsigned long ulong_ptr;
} JL100_REG_PAR;
...
/***********************************************************************/
/*    Global Frame Struct(Big endian)                                  */
/***********************************************************************/
typedef union _JL100_GBL_FRAME {
	struct{
		volatile USHORT sa;				/* Source address */
		volatile USHORT da;				/* Destination address */
		volatile USHORT ftyp_len;		/* Frame type & length */
		volatile USHORT msg_ctrl;		/* Message control */
		volatile ULONG  time;			/* Global time */
		volatile USHORT reserve;			/* Reserve */
		volatile USHORT idly;			/* Interrupt offset time */
		volatile ULONG  fcs;				/* Frame check sequence */
	} str;
	unsigned long ulong_ptr;
} JL100_GBL_FRAME;
...
/***********************************************************************/
/*    Header Info Struct(for async communication)(Big endian)          */
/***********************************************************************/
typedef union _JL100_FRAME_HEADER_ASYNC {
	struct{
		volatile USHORT stat;			/* Status */
		volatile USHORT t_rsp;			/* Transmission response monitering time */
		volatile USHORT sa;				/* Source address */
		volatile USHORT da;				/* Destination address */
		volatile USHORT ftyp_len;		/* Frame type & length */
		volatile USHORT msg_ctrl;		/* Message control */
...
/***********************************************************************/
/*    Header Info Struct(for message communication)(Big endian)        */
/***********************************************************************/
...
#define jl100_get_cmd(pJL)          	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->cmd)
#define jl100_set_cmd(pJL, data)    	(((JL100_HOST_IF_REGS *)pJL)->cmd = jl100s_swaphl((ULONG)data))
#define jl100_get_sts(pJL)          	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->sts)
#define jl100_get_ints(pJL)         	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->ints)
#define jl100_clear_ints(pJL, data) 	(((JL100_HOST_IF_REGS *)pJL)->ints = jl100s_swaphl((ULONG)data))
#define jl100_get_imk(pJL)    			jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->imk)
#define jl100_set_imk(pJL, data)    	(((JL100_HOST_IF_REGS *)pJL)->imk = jl100s_swaphl((ULONG)data))
#define jl100_get_ests(pJL)         	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->ests)
#define jl100_clear_ests(pJL, data) 	(((JL100_HOST_IF_REGS *)pJL)->ests =jl100s_swaphl((ULONG)data))
#define jl100_get_mod(pJL)          	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->mod)
#define jl100_set_mod(pJL, data)    	(((JL100_HOST_IF_REGS *)pJL)->mod = jl100s_swaphl((ULONG)data))
#define jl100_get_cid(pJL)          	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->cid)
#define jl100_get_pars(pJL)				jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->pars)
#define jl100_set_pars(pJL, data)		(((JL100_HOST_IF_REGS *)pJL)->pars = jl100s_swaphl((ULONG)data))
#define jl100_get_sti1(pJL)         	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->sti1)
#define jl100_get_sti2(pJL)         	jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->sti2)
#define jl100_get_crcv1(pJL)			jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->crcv1)
#define jl100_get_crcv2(pJL)			jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->crcv2)
#define jl100_get_rrcv1(pJL)			jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->rrcv1)
#define jl100_get_rrcv2(pJL)			jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->rrcv2)
#define jl100_get_cbadr(pJL)			(jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->cbadr) << 1)	/* << 1 : Word -> Byte */
#define jl100_get_rbadr(pJL)			(jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->rbadr) << 1)	/* << 1 : Word -> Byte */
#define jl100_get_gtim(pJL)				jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->gtim)
#define jl100_get_idly(pJL)				jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->idly)
#define jl100_set_idly(pJL, data)		(((JL100_HOST_IF_REGS *)pJL)->idly = jl100s_swaphl((ULONG)data))
#define jl100_get_m3gar(pJL)			jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->m3_gar)
#define jl100_set_m3gar(pJL, data)		(((JL100_HOST_IF_REGS *)pJL)->m3_gar = jl100s_swaphl((ULONG)data))
#define jl100_get_m3gdr(pJL)			jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->m3_gdr)
#define jl100_set_m3gdr(pJL, data)		(((JL100_HOST_IF_REGS *)pJL)->m3_gdr = jl100s_swaphl((ULONG)data))
#define jl100_get_reserved1(pJL)		jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->reserved1)
#define jl100_set_reserved1(pJL, data)	(((JL100_HOST_IF_REGS *)pJL)->reserved1 = jl100s_swaphl((ULONG)data))
#define jl100_get_reserved2(pJL)		jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->reserved2)
#define jl100_set_reserved2(pJL, data)	(((JL100_HOST_IF_REGS *)pJL)->reserved2 = jl100s_swaphl((ULONG)data))
#define jl100_get_reserved3(pJL)		jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->reserved3)
#define jl100_set_reserved3(pJL, data)	(((JL100_HOST_IF_REGS *)pJL)->reserved3 = jl100s_swaphl((ULONG)data))
#define jl100_get_reserved4(pJL)		jl100s_swaphl(((JL100_HOST_IF_REGS *)pJL)->reserved4)
#define jl100_set_reserved4(pJL, data)	(((JL100_HOST_IF_REGS *)pJL)->reserved4 = jl100s_swaphl((ULONG)data))
#define jl100_set_test(pJL, data)		(((JL100_HOST_IF_REGS *)pJL)->test = jl100s_swaphl((ULONG)data))

#define jl100_read_dwdata(rdp)			jl100s_swaphl(*(ULONG *)rdp); rdp++
#define jl100_read_wdata(rdp)			*((USHORT *)rdp); rdp++
#define jl100_write_dwdata(wtp, rdp)	*((ULONG *)wtp) = jl100s_swaphl(*(ULONG *)rdp); ++wtp; ++rdp
#define jl100_write_wdata(wtp, rdp)		*((USHORT *)wtp) = *((USHORT *)rdp); ++wtp; ++rdp

#define jl100_swap_long_data(x, y)		(y = x)
...
#define jl100_swap_long_data(x, y)		(y = ((x & 0x0000FFFF) << 16) | ((x & 0xFFFF0000) >> 16))
