...
#define	IxLmtCBS16( Src16 )		Src16 							/* limizcb( Src16 )がまだコンパイラに未実装なので今のところ直接代入		*/
#define	IxLmtCBS32( Src32 )		Src32							/* limizcb( Src32 )がまだコンパイラに未実装なので今のところ直接代入		*/
