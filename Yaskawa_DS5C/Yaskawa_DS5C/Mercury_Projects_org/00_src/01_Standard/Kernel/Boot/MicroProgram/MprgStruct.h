...
typedef struct _VER_INFO {
	SHORT	MswVer;				/* 0xC0007284 : ソフトバージョン情報								*/
	SHORT	TstVer;				/* 0xC0007286 : テストバージョン情報								*/
	SHORT	YspVer;				/* 0xC0007288 : Ｙ仕様バージョン情報								*/
	SHORT	Dummy;				/* 0xC000728A : for Alignment										*/
} VER_INFO;
...
typedef struct {
	...
	SHORT			Dummy[292];	/* Dummy buffer for Axis offset										*/
