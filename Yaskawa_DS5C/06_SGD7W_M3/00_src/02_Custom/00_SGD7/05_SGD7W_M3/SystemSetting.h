...
/*		Product information													 */
/*****************************************************************************/
#define MAX_AXIS_NUMBER		2			/* 最大接続軸数 */
#define MAX_SLOT_NUMBER		2			/* 最大スロット(ASIC)数 */

#define SERVO_FIRM_CODE		0x02250001	/* デバイスコード	*//* <S0D9> */
#define TCYC_TIME_MIN		25000		/* 伝送周期最小値	*//* <S159> */
#define CCYC_TIME_MIN		25000		/* 通信周期最小値	*//* <S159> */

#define	CSW_NETIF_TYPE		NETIF_M3_TYPE
#define CSW_BOARD_TYPE		SGD7W_TYPE										  /* <S0A2> */
...
#define EEPROM_SIZE			0x2000		/* EEPROM Memory Size				*//* <S10A> */
...
/*		M-IIIμプログラムダウンロード選択									*/
/*--------------------------------------------------------------------------*/
#define CSW_M3_MICRO_DL				TRUE		/* 7S:FALSE, 7W:TRUE */
...
/*--------------------------------------------------------------------------*/
//#define CSW_NET_TRG_USE				TRUE									/* <S021> */
#define CSW_NET_TRG_USE				FALSE										/* <S035> */
/*--------------------------------------------------------------------------*/
/*		温度ICによるOH使用・不使用設定										*/
/*--------------------------------------------------------------------------*/
#define CSW_DETECT_OH_FROM_TEMPIC 	TRUE
/*--------------------------------------------------------------------------*/
/*		  	  ∑-7/∑-M Option												*/
/*--------------------------------------------------------------------------*/
...
/*		分周パルス出力定義													*/
/*--------------------------------------------------------------------------*/
#define	SVFSEL_DIVOUT_USE			FALSE	 /* 分周出力(TRUE:使用;FALSE:不使用)   *//*<S02D>*/
/*--------------------------------------------------------------------------*/
/*		オプションカード対応定義											*/
/*--------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
#define SERVO_ID			0x075	/* サーボ機種ID : SFD7W_M3 = 0x0075 */
/* <S173> Start */
...
/* 入力/出力信号 有効/無効情報見直し */
//#define INPUT_SIGNAL_INFO	0x007f007f	/* 入力信号 有効/無効情報 */	/* <S17D> */
#define INPUT_SIGNAL_INFO	0x007e007e	/* 入力信号 有効/無効情報 */	/* <S17D> */
										/* SI1～SI6:有効 */
										/* SI0,SI7～SI31:無効 */
#define OUTPUT_SIGNAL_INFO	0x0000007f	/* 出力信号 有効/無効情報 */
										/* ALM0,ALM1,SO1～SO5:有効 */
										/* SO6～SO30:無効 */
										
#define	INPUT_SIGMON_BIT_NUM		12	/* SI0*、SI1*の入力点数(2軸まとめ用)	*//* <S1C0> */
#define	OUTPUT_SIGMON_BIT_NUM		5	/* SO*の出力点数(2軸まとめ用)			*//* <S1C0> */
#define	OUTPUT_SIGMON_BIT_SFT		12	/* SO0の格納位置(2軸まとめ用)			*//* <S1C0> */
/* <S173> End */
/* <S056>	End */
